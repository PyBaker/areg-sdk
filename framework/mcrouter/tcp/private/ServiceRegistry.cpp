...
void ServiceRegistry::getServiceList( ITEM_ID cookie , std::vector<StubAddress> & OUT out_stubServiceList, std::vector<ProxyAddress> & OUT out_proxyServiceList ) const
{
...
void ServiceRegistry::getServiceSources(ITEM_ID cookie, std::vector<StubAddress> & OUT stubSource, std::vector<ProxyAddress> & OUT proxySources)
{
